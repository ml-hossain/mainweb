    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <div ref={headerRef} className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-yellow-500 to-orange-600 mb-8 shadow-2xl">
      ...
      <div className="w-full bg-[#B45309] mt-8 px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link 
              to="/consultation" 
              className="bg-white text-[#B45309] hover:bg-gray-100 px-10 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 inline-flex items-center justify-center group text-lg"
            >
              Find Scholarships
